...
---
        ...
        This entry point explains how an AI coding agent should consume the documentation in order, what to build first, and where to find contracts.

        ## Role In The Product

        StadiumMind AI is intentionally designed as a multi-role platform rather than a single chatbot. This document defines how the start here part of the system should behave, what it depends on, and how an AI coding agent should implement it without guessing missing product decisions.
        ...
        - Read PRD and SRS first.
- Use OpenAPI and Supabase SQL as implementation contracts.
- Use prompt library instead of inventing agent behavior.
- Run demo flow after each major feature.

        ## Functional Requirements

        - Follow the build order in README.
- Do not implement unrelated social, payment, or ticket-purchase features.
- Keep fan flow unauthenticated.
...
- [demo_script.md](docs/demo/demo_script.md)
