...
---
        ...
        Defines how raw operational signals become ranked recommendations.

        ## Role In The Product

        StadiumMind AI is intentionally designed as a multi-role platform rather than a single chatbot. This document defines how the ai decision engine part of the system should behave, what it depends on, and how an AI coding agent should implement it without guessing missing product decisions.
...
- Outcome tracking.
        ...
        - Confidence is a decision estimate, not a mathematical guarantee.
- Backend should calculate or normalize confidence.
...
- [ ] All important actions are captured in the action history or incident timeline when relevant.
        ...
        - [explainability_confidence.md](explainability_confidence.md)
- [recommendation_service.md](../backend/recommendation_service.md)
