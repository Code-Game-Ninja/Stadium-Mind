---
title: "Explainability And Confidence"
...
---
        ...
        Defines the Why button, confidence display, and trust model for AI recommendations.

        ## Role In The Product

        StadiumMind AI is intentionally designed as a multi-role platform rather than a single chatbot. This document defines how the explainability and confidence part of the system should behave, what it depends on, and how an AI coding agent should implement it without guessing missing product decisions.
...
- Risk labels.
        ...
        - Every organizer recommendation must include explainability.
