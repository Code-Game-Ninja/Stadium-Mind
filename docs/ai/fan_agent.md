...
---
        ...
        Specifies fan-facing AI behavior for journey planning, accessibility, route context, food and washroom preferences, and match-day help.

        ## Role In The Product

        StadiumMind AI is intentionally designed as a multi-role platform rather than a single chatbot. This document defines how the fan ai agent part of the system should behave, what it depends on, and how an AI coding agent should implement it without guessing missing product decisions.
...
- Accessibility-aware recommendations.
        ...
        - Never require fan login.
- Never claim real FIFA validation.
- Prioritize accessibility over shortest route.
...
- [ ] All important actions are captured in the action history or incident timeline when relevant.
        ...
        - [fan-agent.md](../../prompts/fan-agent.md)
- [fan_experience.md](../frontend/fan_experience.md)
