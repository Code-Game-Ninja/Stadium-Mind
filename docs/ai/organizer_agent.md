...
---
        ...
        Specifies executive summaries, operational recommendations, map annotations, and report behavior for admins.

        ## Role In The Product

        StadiumMind AI is intentionally designed as a multi-role platform rather than a single chatbot. This document defines how the organizer ai agent part of the system should behave, what it depends on, and how an AI coding agent should implement it without guessing missing product decisions.
...
- Reports.
        ...
        - Recommendations must include reason and expected outcome.
- All action choices are human-in-the-loop.
...
- [ ] All important actions are captured in the action history or incident timeline when relevant.
        ...
        - [organizer-agent.md](../../prompts/organizer-agent.md)
