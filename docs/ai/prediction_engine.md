...
---
        ...
        Defines simulated crowd and operations prediction without custom ML training.

        ## Role In The Product

        StadiumMind AI is intentionally designed as a multi-role platform rather than a single chatbot. This document defines how the prediction engine part of the system should behave, what it depends on, and how an AI coding agent should implement it without guessing missing product decisions.
...
- Food waste risk.
        ...
        - Use rules plus Gemini reasoning.
- Keep predictions explainable.
...
- [ ] All important actions are captured in the action history or incident timeline when relevant.
        ...
        - [prediction-agent.md](../../prompts/prediction-agent.md)
- [simulation_engine.md](../backend/simulation_engine.md)
