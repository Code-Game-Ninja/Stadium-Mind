...
---
        ...
        Defines AI alerts that appear before the organizer asks for them.

        ## Role In The Product

        StadiumMind AI is intentionally designed as a multi-role platform rather than a single chatbot. This document defines how the proactive alerts part of the system should behave, what it depends on, and how an AI coding agent should implement it without guessing missing product decisions.
...
- Sustainability alerts.
        ...
        - Alerts must include signal, prediction window, recommendation, and confidence.
...
- [decision-engine.md](../../prompts/decision-engine.md)
