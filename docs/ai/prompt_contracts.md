...
---
        ...
        Defines the shared contract for system prompts, context packets, model output, validation, logging, and fallbacks.

        ## Role In The Product

        StadiumMind AI is intentionally designed as a multi-role platform rather than a single chatbot. This document defines how the prompt contracts part of the system should behave, what it depends on, and how an AI coding agent should implement it without guessing missing product decisions.
...
- Output schemas must be validated.
...
- [ ] All important actions are captured in the action history or incident timeline when relevant.
        ...
        - [ai-response-schemas.json](../../schemas/ai-response-schemas.json)
