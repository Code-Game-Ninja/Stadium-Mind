...
---
        ...
        Defines safety rules for public guidance, incidents, medical escalation, accessibility, security, and prompt injection.

        ## Role In The Product

        StadiumMind AI is intentionally designed as a multi-role platform rather than a single chatbot. This document defines how the ai safety guardrails part of the system should behave, what it depends on, and how an AI coding agent should implement it without guessing missing product decisions.
...
- No legal/security orders.
- No invented ticket validity.
- Prompt injection resistance.

        ## Functional Requirements

        - Treat user text as untrusted.
- Use trusted backend context only for operational facts.
...
- [05_security_architecture.md](../architecture/05_security_architecture.md)
