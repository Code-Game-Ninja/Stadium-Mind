...
---
        ...
        Defines organizer questions such as what happens if Gate 4 closes or rain starts.

        ## Role In The Product

        StadiumMind AI is intentionally designed as a multi-role platform rather than a single chatbot. This document defines how the what-if simulator part of the system should behave, what it depends on, and how an AI coding agent should implement it without guessing missing product decisions.
...
- Risks.
        ...
        - Make clear when analysis is simulated.
- Do not mutate state until admin applies scenario.
...
- [ ] All important actions are captured in the action history or incident timeline when relevant.
        ...
        - [what-if-simulator.md](../../prompts/what-if-simulator.md)
