...
---
        ...
        Defines the system context around fans, volunteers, organizers, Supabase, Gemini, and deployment providers.

        ## Role In The Product

        StadiumMind AI is intentionally designed as a multi-role platform rather than a single chatbot. This document defines how the c4 context part of the system should behave, what it depends on, and how an AI coding agent should implement it without guessing missing product decisions.
...
- Trust boundaries.
        ...
        - Show what is inside and outside the MVP.
- Identify which systems are simulated.
...
- [system_context.md](../diagrams/system_context.md)
