...
---
        ...
        Explains how match, ticket, simulation, incident, recommendation, AI, and action-history data move through the product.

        ## Role In The Product

        StadiumMind AI is intentionally designed as a multi-role platform rather than a single chatbot. This document defines how the data flow architecture part of the system should behave, what it depends on, and how an AI coding agent should implement it without guessing missing product decisions.
...
- AI data flow.
        ...
        - Backend must own trusted context assembly.
