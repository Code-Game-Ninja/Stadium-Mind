...
---
        ...
        Defines Socket.IO responsibilities and the event model used to make the command center feel alive.

        ## Role In The Product

        StadiumMind AI is intentionally designed as a multi-role platform rather than a single chatbot. This document defines how the realtime architecture part of the system should behave, what it depends on, and how an AI coding agent should implement it without guessing missing product decisions.
...
- Fallback behavior.
        ...
        - Dashboard must update from events.
- Simulation controls must emit scenario events.
...
- [realtime_events.md](../diagrams/realtime_events.md)
