...
---
        ...
        Specifies the deployment split for Vercel, Railway or Render, Supabase, and environment variables.

        ## Role In The Product

        StadiumMind AI is intentionally designed as a multi-role platform rather than a single chatbot. This document defines how the deployment architecture part of the system should behave, what it depends on, and how an AI coding agent should implement it without guessing missing product decisions.
...
- Secrets and CORS.
        ...
        - Keep demo deployment simple.
- Support local and hosted modes.
...
- [ ] All important actions are captured in the action history or incident timeline when relevant.
        ...
        - [vercel.md](../deployment/vercel.md)
- [railway.md](../deployment/railway.md)
