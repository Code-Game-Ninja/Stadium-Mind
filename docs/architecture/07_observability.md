...
---
        ...
        Defines logging, AI logs, action history, demo diagnostics, and error reporting.

        ## Role In The Product

        StadiumMind AI is intentionally designed as a multi-role platform rather than a single chatbot. This document defines how the observability part of the system should behave, what it depends on, and how an AI coding agent should implement it without guessing missing product decisions.
...
- Frontend demo status.
        ...
        - Every AI response should be logged with fallback flag.
- Every recommendation decision should enter action history.
