...
---
        ...
        Defines REST API conventions, error format, auth, validation, and service boundaries.

        ## Role In The Product

        StadiumMind AI is intentionally designed as a multi-role platform rather than a single chatbot. This document defines how the backend api design part of the system should behave, what it depends on, and how an AI coding agent should implement it without guessing missing product decisions.
...
- Pagination.
        ...
        - Implement OpenAPI as contract.
- Public and protected endpoints must be clearly separated.
