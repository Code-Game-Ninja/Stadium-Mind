...
---
        ...
        Specifies Supabase Auth integration and role-based access for admin and volunteer users.

        ## Role In The Product

        StadiumMind AI is intentionally designed as a multi-role platform rather than a single chatbot. This document defines how the auth and rbac part of the system should behave, what it depends on, and how an AI coding agent should implement it without guessing missing product decisions.
...
- Profile creation.
        ...
        - Fans do not log in.
- Admin and volunteer routes require role checks.
