...
---
        ...
        Defines incident creation, assignment, status updates, and timeline integration.

        ## Role In The Product

        StadiumMind AI is intentionally designed as a multi-role platform rather than a single chatbot. This document defines how the incident service part of the system should behave, what it depends on, and how an AI coding agent should implement it without guessing missing product decisions.
...
- Publish event.
        ...
        - Volunteers can create incidents.
- Admins can manage and close incidents.
...
- [ ] All important actions are captured in the action history or incident timeline when relevant.
        ...
        - [volunteer_workspace.md](../frontend/volunteer_workspace.md)
