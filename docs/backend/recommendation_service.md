...
---
        ...
        Defines how AI recommendations are normalized, stored, applied, dismissed, and logged.

        ## Role In The Product

        StadiumMind AI is intentionally designed as a multi-role platform rather than a single chatbot. This document defines how the recommendation service part of the system should behave, what it depends on, and how an AI coding agent should implement it without guessing missing product decisions.
...
- Every decision enters action history.
...
- [ ] All important actions are captured in the action history or incident timeline when relevant.
        ...
        - [decision_engine.md](../ai/decision_engine.md)
