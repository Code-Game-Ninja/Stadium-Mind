...
---
        ...
        Defines service modules for matches, tickets, AI, recommendations, incidents, simulation, reports, and realtime.

        ## Role In The Product

        StadiumMind AI is intentionally designed as a multi-role platform rather than a single chatbot. This document defines how the backend services part of the system should behave, what it depends on, and how an AI coding agent should implement it without guessing missing product decisions.
