...
---
        ...
        Specifies deterministic operational scenarios used to replace real sensors.

        ## Role In The Product

        StadiumMind AI is intentionally designed as a multi-role platform rather than a single chatbot. This document defines how the simulation engine part of the system should behave, what it depends on, and how an AI coding agent should implement it without guessing missing product decisions.
...
- Power issue.
        ...
        - Each scenario must change metrics and produce timeline events.
- Scenarios should be reversible by reset.
...
- [ ] All important actions are captured in the action history or incident timeline when relevant.
        ...
        - [prediction_engine.md](../ai/prediction_engine.md)
