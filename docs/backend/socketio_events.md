...
---
        ...
        Defines realtime event names, payloads, rooms, and update rules.

        ## Role In The Product

        StadiumMind AI is intentionally designed as a multi-role platform rather than a single chatbot. This document defines how the socket.io events part of the system should behave, what it depends on, and how an AI coding agent should implement it without guessing missing product decisions.
...
- Simulation events.
        ...
        - Events must be documented and stable.
- Clients should reconcile snapshots after reconnect.
...
- [ ] All important actions are captured in the action history or incident timeline when relevant.
        ...
        - [04_realtime_architecture.md](../architecture/04_realtime_architecture.md)
