...
---
        ...
        Defines ticket ID and QR verification behavior for demo tickets.

        ## Role In The Product

        StadiumMind AI is intentionally designed as a multi-role platform rather than a single chatbot. This document defines how the ticket service part of the system should behave, what it depends on, and how an AI coding agent should implement it without guessing missing product decisions.
...
- Verified context.
        ...
        - Do not expose full ticket table publicly.
- Return only planning context.
...
- [ ] All important actions are captured in the action history or incident timeline when relevant.
        ...
        - [ticket_qr_flow.md](../frontend/ticket_qr_flow.md)
- [functions.sql](../../supabase/functions.sql)
