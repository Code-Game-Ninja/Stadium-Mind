...
---
        ...
        Documents row-level security behavior for public, volunteer, and admin access.

        ## Role In The Product

        StadiumMind AI is intentionally designed as a multi-role platform rather than a single chatbot. This document defines how the rls policies part of the system should behave, what it depends on, and how an AI coding agent should implement it without guessing missing product decisions.
        ...
        - Public read match data.
- Protected operational data.
- Admin management.
- Volunteer incident creation.

        ## Functional Requirements

        - Ticket verification must run through backend.
- No broad public ticket reads.
...
- [ ] All important actions are captured in the action history or incident timeline when relevant.
        ...
        - [policies.sql](../../supabase/policies.sql)
