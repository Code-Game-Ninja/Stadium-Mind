...
---
        ...
        Documents all Supabase tables, relationships, indexes, and intended use.

        ## Role In The Product

        StadiumMind AI is intentionally designed as a multi-role platform rather than a single chatbot. This document defines how the database schema part of the system should behave, what it depends on, and how an AI coding agent should implement it without guessing missing product decisions.
...
- AI logs.
        ...
        - Schema must match supabase/schema.sql.
- Every operational table must include match context where relevant.
...
- [database_er.md](../diagrams/database_er.md)
