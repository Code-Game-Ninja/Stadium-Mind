...
---
        ...
        Explains demo matches, tickets, zones, volunteers, metrics, and scenarios.

        ## Role In The Product

        StadiumMind AI is intentionally designed as a multi-role platform rather than a single chatbot. This document defines how the seed data part of the system should behave, what it depends on, and how an AI coding agent should implement it without guessing missing product decisions.
...
- Initial metrics.
        ...
        - Seed data must support the demo script.
- Ticket mismatch should be demonstrable.
