...
---
        ...
        Explains how Supabase supports Auth, Postgres, RLS, and seed data for the prototype.

        ## Role In The Product

        StadiumMind AI is intentionally designed as a multi-role platform rather than a single chatbot. This document defines how the supabase overview part of the system should behave, what it depends on, and how an AI coding agent should implement it without guessing missing product decisions.
...
- Service role backend access.
        ...
        - Use Supabase for admin and volunteer users only.
- Fans use ticket context.
