...
---
        ...
        Provides the exact five-minute story for judges.

        ## Role In The Product

        StadiumMind AI is intentionally designed as a multi-role platform rather than a single chatbot. This document defines how the demo script part of the system should behave, what it depends on, and how an AI coding agent should implement it without guessing missing product decisions.
...
- End report.
        ...
        - Show action, not just chat.
- Use simulation controls live.
...
- [ ] All important actions are captured in the action history or incident timeline when relevant.
        ...
        - [judging_strategy.md](judging_strategy.md)
