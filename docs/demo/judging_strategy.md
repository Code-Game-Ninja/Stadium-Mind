...
---
        ...
        Explains how to position the project against basic chatbot submissions.

        ## Role In The Product

        StadiumMind AI is intentionally designed as a multi-role platform rather than a single chatbot. This document defines how the judging strategy part of the system should behave, what it depends on, and how an AI coding agent should implement it without guessing missing product decisions.
...
- Demo reliability.
        ...
        - Emphasize operating system concept.
- Show explainable human-in-the-loop AI.
...
- [01_product_vision.md](../product/01_product_vision.md)
