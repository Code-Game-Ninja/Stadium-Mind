...
---
        ...
        Provides a narrated script for a short submission video.

        ## Role In The Product

        StadiumMind AI is intentionally designed as a multi-role platform rather than a single chatbot. This document defines how the video script part of the system should behave, what it depends on, and how an AI coding agent should implement it without guessing missing product decisions.
...
- Closing impact.
        ...
        - Keep under required limit.
- Show product screens more than slides.
