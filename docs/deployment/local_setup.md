...
---
        ...
        Defines how a developer or AI coding agent should configure local frontend, backend, Supabase, and environment variables.

        ## Role In The Product

        StadiumMind AI is intentionally designed as a multi-role platform rather than a single chatbot. This document defines how the local setup part of the system should behave, what it depends on, and how an AI coding agent should implement it without guessing missing product decisions.
