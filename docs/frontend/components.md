...
---
        ...
        Defines reusable components for cards, maps, alerts, timelines, recommendation panels, modals, and controls.

        ## Role In The Product

        StadiumMind AI is intentionally designed as a multi-role platform rather than a single chatbot. This document defines how the frontend components part of the system should behave, what it depends on, and how an AI coding agent should implement it without guessing missing product decisions.
...
- JourneyStepList.
        ...
        - Components must be responsive and role-aware.
...
- [ ] All important actions are captured in the action history or incident timeline when relevant.
        ...
        - [design_system.md](../ui/design_system.md)
- [wireframes.md](../ui/wireframes.md)
