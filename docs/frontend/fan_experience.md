...
---
        ...
        Specifies the fan journey planner, AI chat, timeline, map route, and live queue context.

        ## Role In The Product

        StadiumMind AI is intentionally designed as a multi-role platform rather than a single chatbot. This document defines how the fan experience part of the system should behave, what it depends on, and how an AI coding agent should implement it without guessing missing product decisions.
...
- AI chat.
        ...
        - Journey plan must show route, time, warnings, and accessibility notes.
