...
---
        ...
        Specifies the public landing surface where fans select matches, explore stadiums, and begin ticket verification.

        ## Role In The Product

        StadiumMind AI is intentionally designed as a multi-role platform rather than a single chatbot. This document defines how the match hub part of the system should behave, what it depends on, and how an AI coding agent should implement it without guessing missing product decisions.
...
- Live status summary.
        ...
        - Fan can proceed without login.
- Ticket verification must be match-specific.
...
- [ ] All important actions are captured in the action history or incident timeline when relevant.
        ...
        - [ticket_qr_flow.md](ticket_qr_flow.md)
- [05_user_flows.md](../product/05_user_flows.md)
