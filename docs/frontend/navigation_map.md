...
---
        ...
        Specifies the 2D stadium map, route rendering, zone colors, accessibility route variants, and crowd overlays.

        ## Role In The Product

        StadiumMind AI is intentionally designed as a multi-role platform rather than a single chatbot. This document defines how the navigation map part of the system should behave, what it depends on, and how an AI coding agent should implement it without guessing missing product decisions.
...
- Accessibility paths.
        ...
        - Use deterministic map data.
- Do not depend on Mapbox paid features for MVP.
...
- [fan_experience.md](fan_experience.md)
