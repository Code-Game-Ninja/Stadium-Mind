...
---
        ...
        Specifies the admin dashboard: stadium health, digital twin, recommendations, timeline, simulation controls, what-if, reports.

        ## Role In The Product

        StadiumMind AI is intentionally designed as a multi-role platform rather than a single chatbot. This document defines how the organizer command center part of the system should behave, what it depends on, and how an AI coding agent should implement it without guessing missing product decisions.
...
- Simulation panel.
        ...
        - This screen is the core demo surface.
- Apply recommendation must update visible metrics.
...
- [ ] All important actions are captured in the action history or incident timeline when relevant.
        ...
        - [organizer_agent.md](../ai/organizer_agent.md)
