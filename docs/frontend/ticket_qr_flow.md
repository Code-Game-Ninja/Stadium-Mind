...
---
        ...
        Specifies ticket ID input, QR simulation, mismatch handling, and verified ticket context.

        ## Role In The Product

        StadiumMind AI is intentionally designed as a multi-role platform rather than a single chatbot. This document defines how the ticket and qr flow part of the system should behave, what it depends on, and how an AI coding agent should implement it without guessing missing product decisions.
...
- Verified context card.

        ## Functional Requirements

        - A ticket for another match must be rejected with a helpful reason.
...
- [ ] All important actions are captured in the action history or incident timeline when relevant.
        ...
        - [ticket_service.md](../backend/ticket_service.md)
- [WC2026-453621.json](../../assets/sample-tickets/WC2026-453621.json)
