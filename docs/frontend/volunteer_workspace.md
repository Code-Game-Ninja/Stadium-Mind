...
---
        ...
        Specifies volunteer login, station, tasks, SOP assistant, incidents, lost and found, and translation.

        ## Role In The Product

        StadiumMind AI is intentionally designed as a multi-role platform rather than a single chatbot. This document defines how the volunteer workspace part of the system should behave, what it depends on, and how an AI coding agent should implement it without guessing missing product decisions.
...
- SOP answers should be action-oriented.
...
- [ ] All important actions are captured in the action history or incident timeline when relevant.
        ...
        - [volunteer_agent.md](../ai/volunteer_agent.md)
- [incident_service.md](../backend/incident_service.md)
