...
---
        ...
        Defines the product strategy and why StadiumMind AI should feel like an operating system rather than an isolated chatbot.

        ## Role In The Product

        StadiumMind AI is intentionally designed as a multi-role platform rather than a single chatbot. This document defines how the product vision part of the system should behave, what it depends on, and how an AI coding agent should implement it without guessing missing product decisions.
        ...
        - Unify fan, volunteer, and organizer needs.
- Make AI actionable and explainable.
- Use simulation to show real-time intelligence.
- Deliver a polished competition demo.

        ## Functional Requirements

        - Clearly state the core problem.
- Describe the three user roles.
- Explain why Gemini-only AI is sufficient.
...
- [judging_strategy.md](../demo/judging_strategy.md)
