...
---
        ...
        Defines the exact users the MVP should serve and the decisions each persona needs to make during a match day.

        ## Role In The Product

        StadiumMind AI is intentionally designed as a multi-role platform rather than a single chatbot. This document defines how the user personas part of the system should behave, what it depends on, and how an AI coding agent should implement it without guessing missing product decisions.
        ...
        - Fan persona with ticket.
- Fan or visitor without ticket.
- Volunteer persona.
- Organizer persona.
- Judge persona.
        ...
        - Each persona must include goals, frustrations, primary screens, and success outcomes.
- Personas must map to user flows.
...
- [ ] All important actions are captured in the action history or incident timeline when relevant.
        ...
        - [05_user_flows.md](05_user_flows.md)
- [match_hub.md](../frontend/match_hub.md)
