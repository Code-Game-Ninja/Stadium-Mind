...
---
        ...
        Documents the end-to-end flows from Match Hub to journey planning, volunteer incident handling, and organizer command decisions.

        ## Role In The Product

        StadiumMind AI is intentionally designed as a multi-role platform rather than a single chatbot. This document defines how the user flows part of the system should behave, what it depends on, and how an AI coding agent should implement it without guessing missing product decisions.
...
- Fan preferences.
- Volunteer SOP.
- Organizer proactive alert.
- What-if simulator.

        ## Functional Requirements

        - Every MVP flow must include success, error, and fallback states.
- Fan flow must support no-login access.
...
- [ ] All important actions are captured in the action history or incident timeline when relevant.
        ...
        - [fan_flow.md](../diagrams/fan_flow.md)
- [organizer_flow.md](../diagrams/organizer_flow.md)
