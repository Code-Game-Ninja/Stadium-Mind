...
---
        ...
        Captures what is intentionally included and excluded for a five-day build.

        ## Role In The Product

        StadiumMind AI is intentionally designed as a multi-role platform rather than a single chatbot. This document defines how the scope and tradeoffs part of the system should behave, what it depends on, and how an AI coding agent should implement it without guessing missing product decisions.
...
- Demo-first choices.
        ...
        - Explain why real ticketing, voice AI, custom ML, and IoT are excluded.
- Explain how simulation keeps the product credible.
...
- [ ] All important actions are captured in the action history or incident timeline when relevant.
        ...
        - [five_day_plan.md](../roadmap/five_day_plan.md)
