...
---
        ...
        Defines post-hackathon expansion paths: real ticketing, sensors, computer vision, voice, multilingual city-wide support.

        ## Role In The Product

        StadiumMind AI is intentionally designed as a multi-role platform rather than a single chatbot. This document defines how the future roadmap part of the system should behave, what it depends on, and how an AI coding agent should implement it without guessing missing product decisions.
...
- Commercialization.
        ...
        - Separate future scope from MVP.
- Do not build future features in five-day MVP.
