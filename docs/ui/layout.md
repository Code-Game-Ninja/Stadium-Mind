...
---
        ...
        Defines page layouts for Match Hub, Fan Journey, Volunteer Workspace, and Organizer Command Center.

        ## Role In The Product

        StadiumMind AI is intentionally designed as a multi-role platform rather than a single chatbot. This document defines how the layout system part of the system should behave, what it depends on, and how an AI coding agent should implement it without guessing missing product decisions.
