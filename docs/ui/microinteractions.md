...
---
        ...
        Defines small interactions: applying recommendations, opening Why modal, timeline updates, simulation buttons.

        ## Role In The Product

        StadiumMind AI is intentionally designed as a multi-role platform rather than a single chatbot. This document defines how the microinteractions part of the system should behave, what it depends on, and how an AI coding agent should implement it without guessing missing product decisions.
