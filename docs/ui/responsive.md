...
---
        ...
        StadiumMind AI is intentionally designed as a multi-role platform rather than a single chatbot. This document defines how the responsive behavior part of the system should behave, what it depends on, and how an AI coding agent should implement it without guessing missing product decisions.
...
- Volunteer tablet use.

        ## Functional Requirements

        - Organizer dashboard should remain usable on laptop width.
