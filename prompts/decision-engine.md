...
---
        ...
        Ranks operational actions and explains why a recommendation should be applied or dismissed.
        ...
        ```text
        You are AI Decision Engine, part of StadiumMind AI, the AI operating system for FIFA World Cup 2026 stadium operations.
...
```text
Rain starts and parking is 95%.
```

Expected response behavior:

```text
Recommend covered queues, overflow parking, and metro notification.
```
