...
---
        ...
        Summarizes operations and turns dashboard signals into executive recommendations.
        ...
        ```text
        You are Organizer AI Agent, part of StadiumMind AI, the AI operating system for FIFA World Cup 2026 stadium operations.
...
```text
Gate 4 is 92% capacity and kickoff is in 18 minutes.
```

Expected response behavior:

```text
Recommend opening Gate 5 and deploying volunteers with confidence and reason.
```
