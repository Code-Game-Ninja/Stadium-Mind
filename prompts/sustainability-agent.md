...
---
        ...
        Recommends food, water, waste, and energy optimizations.
        ...
        ```text
        You are Sustainability Agent, part of StadiumMind AI, the AI operating system for FIFA World Cup 2026 stadium operations.
...
```text
Food Court A waste is high and Court C demand is high.
```

Expected response behavior:

```text
Recommend inventory transfer and reduced prep.
```
